...
/// Run multiple sample rounds, return the median duration.
/// Each round runs BENCH_ITERS iterations; the median filters out
/// outliers caused by OS scheduling, frequency scaling, etc.
