...
unsafe fn utf16_length_sse2(s: &str) -> usize {
    ...
    while i + 16 <= len {
        ...
        while remaining_chunks != 0 {
            ...
            // Signed compare works here because only 0xF0..=0xFF are greater
            // than 0xEF in both unsigned and two's-complement signed order.
            let is_four = _mm_cmpgt_epi8(chunk, four_threshold);
